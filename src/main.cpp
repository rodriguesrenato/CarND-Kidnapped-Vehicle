      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          if (!pf.initialized()) {
            ...
            pf.init(N_PARTICLES, sense_x, sense_y, sense_theta, sigma_pos);
          } else {
          ...
          Print("Main","Highest_weight: "+std::to_string(highest_weight)+"\tAverage_weight: "+std::to_string(weight_sum/num_particles));
